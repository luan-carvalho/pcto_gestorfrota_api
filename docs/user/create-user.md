...
Create a new user and returns the access token for first access.
...
> **⚠️ OBS:** _The first access token will be used to validate the user first-access status to allow them to create its password to login._
