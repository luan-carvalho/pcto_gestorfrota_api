package br.edu.ifto.gestorfrotaapi.user.model;
...
import br.edu.ifto.gestorfrotaapi.user.exception.StatusUpdateException;
import br.edu.ifto.gestorfrotaapi.user.exception.UserCreationException;
