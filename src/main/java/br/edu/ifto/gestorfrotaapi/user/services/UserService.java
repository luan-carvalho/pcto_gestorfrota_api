package br.edu.ifto.gestorfrotaapi.user.services;
...
import br.edu.ifto.gestorfrotaapi.user.exception.CpfAlreadyRegistered;
...
import br.edu.ifto.gestorfrotaapi.user.repository.filter.UserFilter;
import br.edu.ifto.gestorfrotaapi.user.repository.spec.UserSpecification;
...
public class UserService {
    ...
    public Page<UserResponseDto> findAll(UserFilter filter, Pageable pageable) {
        ...
        Specification<User> spec = Specification
                .<User>unrestricted()
                .and(UserSpecification.hasId(filter.id()))
