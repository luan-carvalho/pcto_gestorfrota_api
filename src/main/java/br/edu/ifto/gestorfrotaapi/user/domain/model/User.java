package br.edu.ifto.gestorfrotaapi.user.domain.model;
...
import br.edu.ifto.gestorfrotaapi.user.domain.exception.StatusUpdateException;
import br.edu.ifto.gestorfrotaapi.user.domain.exception.UserCreationException;
