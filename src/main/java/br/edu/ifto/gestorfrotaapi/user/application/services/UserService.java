package br.edu.ifto.gestorfrotaapi.user.application.services;
...
import br.edu.ifto.gestorfrotaapi.domain.authentication.repository.UserRepository;
import br.edu.ifto.gestorfrotaapi.infra.security.util.TokenGenerator;
...
import br.edu.ifto.gestorfrotaapi.user.domain.exception.CpfAlreadyRegistered;
...
import br.edu.ifto.gestorfrotaapi.user.persistence.filter.UserFilter;
import br.edu.ifto.gestorfrotaapi.user.persistence.spec.UserSpecification;
